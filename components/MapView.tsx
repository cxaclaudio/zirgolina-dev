        ...
        municipiosRef.current = L.geoJSON(geojson, {
          ...
          onEachFeature(feature: any, layer: any) {
            ...
            if (distritoId && conNome) {
              concelhoLayerMap[`${distritoId}_${normalizeName(conNome)}`] = layer;
            }
          ...
          const icon = L.divIcon({
            ...
            html: mostrarBalao
              ? `<div style="display:flex;flex-direction:column;align-items:center;cursor:pointer">
                  <div style="background:${balaoBg};color:${balaoColor};border:1.5px solid ${balaoBorder};border-radius:5px;padding:2px 6px;font-size:11px;font-weight:700;font-family:sans-serif;white-space:nowrap;box-shadow:0 2px 6px rgba(0,0,0,0.16);line-height:1.4;position:relative;">
                    ${precoDisplay}
                    <div style="position:absolute;bottom:-4px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:4px solid transparent;border-right:4px solid transparent;border-top:4px solid ${balaoBorder};"></div>
                  </div>
                  <div style="width:${pinSize}px;height:${pinSize}px;border-radius:50%;background:${marcaCor};box-shadow:0 1px 3px rgba(0,0,0,.3);margin-top:4px;"></div>
                </div>`
              : `<div style="width:${pinSize}px;height:${pinSize}px;border-radius:50%;background:${marcaCor};box-shadow:0 1px 4px rgba(0,0,0,.35);"></div>`,
